...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=ut(),d;if(t){let e=typeof t==`string`?oe(t):t;w(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=le(e,{pathname:p});T(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),T(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=wt(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Pe([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Pe([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?_.createElement(et.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,unstable_mask:void 0,...d},navigationType:`POP`}},h):h}function vt(){let e=Mt(),t=Be(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=_.createElement(_.Fragment,null,_.createElement(`p`,null,`💿 Hey developer 👋`),_.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,_.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,_.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),_.createElement(_.Fragment,null,_.createElement(`h2`,null,`Unexpected Application Error!`),_.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?_.createElement(`pre`,{style:i},n):null,o)}var yt=_.createElement(vt,null),bt=class extends _.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=st(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:_.createElement(tt.Provider,{value:this.props.routeContext},_.createElement(nt.Provider,{value:e,children:this.props.component}));return this.context?_.createElement(St,{error:e},t):t}};bt.contextType=Je;var xt=new WeakMap;function St({children:e,error:t}){let{basename:n}=_.useContext($e);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=ot(t.digest);if(e){let r=xt.get(t);if(r)throw r;let i=Ue(e.location,n);if(He&&!xt.get(t))if(i.isExternal||e.reloadDocument)window.location.href=i.absoluteURL||i.to;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(i.to,{replace:e.replace}));throw xt.set(t,n),n}return _.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${i.absoluteURL||i.to}`})}}return e}function Ct({routeContext:e,match:t,children:n}){let r=_.useContext(Ke);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),_.createElement(tt.Provider,{value:e},n)}function wt(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);w(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},unstable_pattern:Ve(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||yt,o&&(s<0&&c===0?(Ft(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?_.createElement(n.route.Component,null):n.route.element?n.route.element:e,_.createElement(Ct,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?_.createElement(bt,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function Tt(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Et(e){let t=_.useContext(Ke);return w(t,Tt(e)),t}function Dt(e){let t=_.useContext(qe);return w(t,Tt(e)),t}function Ot(e){let t=_.useContext(tt);return w(t,Tt(e)),t}function k(e){let t=Ot(e),n=t.matches[t.matches.length-1];return w(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function kt(){return k(`useRouteId`)}function At(){return Dt(`useNavigation`).navigation}function jt(){let{matches:e,loaderData:t}=Dt(`useMatches`);return _.useMemo(()=>e.map(e=>D(e,t)),[e,t])}function Mt(){let e=_.useContext(nt),t=Dt(`useRouteError`),n=k(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Nt(){let{router:e}=Et(`useNavigate`),t=k(`useNavigate`),n=_.useRef(!1);return ft(()=>{n.current=!0}),_.useCallback(async(r,i={})=>{T(n.current,dt),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var Pt={};function Ft(e,t,n){!t&&!Pt[e]&&(Pt[e]=!0,T(!1,n))}_.memo(It);function It({routes:e,future:t,state:n,isStatic:r,onError:i}){return _t(e,void 0,{state:n,isStatic:r,onError:i,future:t})}function Lt(e){w(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Rt({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,unstable_useTransitions:o}){w(!lt(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=_.useMemo(()=>({basename:s,navigator:i,static:a,unstable_useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=oe(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,unstable_mask:m}=n,h=_.useMemo(()=>{let e=Te(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,unstable_mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return T(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:_.createElement($e.Provider,{value:c},_.createElement(et.Provider,{children:t,value:h}))}function zt({children:e,location:t}){return gt(Bt(e),t)}_.Component;function Bt(e,t=[]){let n=[];return _.Children.forEach(e,(e,r)=>{if(!_.isValidElement(e))return;let i=[...t,r];if(e.type===_.Fragment){n.push.apply(n,Bt(e.props.children,i));return}w(e.type===Lt,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),w(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Bt(e.props.children,i)),n.push(a)}),n}var Vt=`get`,Ht=`application/x-www-form-urlencoded`;function Ut(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function Wt(e){return Ut(e)&&e.tagName.toLowerCase()===`button`}function Gt(e){return Ut(e)&&e.tagName.toLowerCase()===`form`}function Kt(e){return Ut(e)&&e.tagName.toLowerCase()===`input`}function qt(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Jt(e,t){return e.button===0&&(!t||t===`_self`)&&!qt(e)}var Yt=null;function Xt(){if(Yt===null)try{new FormData(document.createElement(`form`),0),Yt=!1}catch{Yt=!0}return Yt}var Zt=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function Qt(e){return e!=null&&!Zt.has(e)?(T(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ht}"`),null):e}function $t(e,t){let n,r,i,a,o;if(Gt(e)){let o=e.getAttribute(`action`);r=o?Te(o,t):null,n=e.getAttribute(`method`)||Vt,i=Qt(e.getAttribute(`enctype`))||Ht,a=new FormData(e)}else if(Wt(e)||Kt(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?Te(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Vt,i=Qt(e.getAttribute(`formenctype`))||Qt(o.getAttribute(`enctype`))||Ht,a=new FormData(o,e),!Xt()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(Ut(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Vt,r=null,i=Ht,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);var en={"&":`\\u0026`,">":`\\u003e`,"<":`\\u003c`,"\u2028":`\\u2028`,"\u2029":`\\u2029`},tn=/[&><\u2028\u2029]/g;function nn(e){return e.replace(tn,e=>en[e])}function rn(e,t){if(e===!1||e==null)throw Error(t)}function an(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return n?i.pathname.endsWith(`/`)?i.pathname=`${i.pathname}_.${r}`:i.pathname=`${i.pathname}.${r}`:i.pathname===`/`?i.pathname=`_root.${r}`:t&&Te(i.pathname,t)===`/`?i.pathname=`${Fe(t)}/_root.${r}`:i.pathname=`${Fe(i.pathname)}.${r}`,i}async function on(e,t){if(e.id in t)return t[e.id];try{let n=await ee(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function sn(e){return e!=null&&typeof e.page==`string`}function cn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function ln(e,t,n){return mn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await on(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(cn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function un(e,t,n,r,i,a){let o=(e,t)=>n[t]?e.route.id!==n[t].route.id:!0,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function dn(e,t,{includeHydrateFallback:n}={}){return fn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function fn(e){return[...new Set(e)]}function pn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function mn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!sn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(pn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function hn(){let e=_.useContext(Ke);return rn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function gn(){let e=_.useContext(qe);return rn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var _n=_.createContext(void 0);_n.displayName=`FrameworkContext`;function vn(){let e=_.useContext(_n);return rn(e,`You must render this element inside a <HydratedRouter> element`),e}function yn(e,t){let n=_.useContext(_n),[r,i]=_.useState(!1),[a,o]=_.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=_.useRef(null);_.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),_.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:bn(s,p),onBlur:bn(c,m),onMouseEnter:bn(l,p),onMouseLeave:bn(u,m),onTouchStart:bn(d,p)}]:[a,f,{}]:[!1,f,{}]}function bn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function xn({page:e,...t}){let n=Ye(),{router:r}=hn(),i=_.useMemo(()=>le(r.routes,e,r.basename),[r.routes,e,r.basename]);return i?n?_.createElement(Cn,{page:e,matches:i,...t}):_.createElement(wn,{page:e,matches:i,...t}):null}function Sn(e){let{manifest:t,routeModules:n}=vn(),[r,i]=_.useState([]);return _.useEffect(()=>{let r=!1;return ln(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function Cn({page:e,matches:t,...n}){let r=ut(),{future:i}=vn(),{basename:a}=hn(),o=_.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=an(e,a,i.unstable_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.unstable_trailingSlashAwareDataRequests,e,r,t]);return _.createElement(_.Fragment,null,o.map(e=>_.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function wn({page:e,matches:t,...n}){let r=ut(),{future:i,manifest:a,routeModules:o}=vn(),{basename:s}=hn(),{loaderData:c,matches:l}=gn(),u=_.useMemo(()=>un(e,t,l,a,r,`data`),[e,t,l,a,r]),d=_.useMemo(()=>un(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=_.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=an(e,s,i.unstable_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.unstable_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=_.useMemo(()=>dn(d,a),[d,a]),m=Sn(d);return _.createElement(_.Fragment,null,f.map(e=>_.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>_.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>_.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function Tn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}_.Component;var En=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{En&&(window.__reactRouterVersion=`7.14.2`)}catch{}function Dn({basename:e,children:t,unstable_useTransitions:n,window:r}){let i=_.useRef();i.current??=te({window:r,v5Compat:!0});let a=i.current,[o,s]=_.useState({action:a.action,location:a.location}),c=_.useCallback(e=>{n===!1?s(e):_.startTransition(()=>s(e))},[n]);return _.useLayoutEffect(()=>a.listen(c),[a,c]),_.createElement(Rt,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,unstable_useTransitions:n})}function On({basename:e,children:t,history:n,unstable_useTransitions:r}){let[i,a]=_.useState({action:n.action,location:n.location}),o=_.useCallback(e=>{r===!1?a(e):_.startTransition(()=>a(e))},[r]);return _.useLayoutEffect(()=>n.listen(o),[n,o]),_.createElement(Rt,{basename:e,children:t,location:i.location,navigationType:i.action,navigator:n,unstable_useTransitions:r})}On.displayName=`unstable_HistoryRouter`;var kn=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,An=_.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,unstable_mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,unstable_useTransitions:v}=_.useContext($e),y=typeof l==`string`&&kn.test(l),b=Ue(l,h);l=b.to;let x=ct(l,{relative:r}),ee=ut(),S=null;if(o){let e=Me(o,[],ee.unstable_mask?ee.unstable_mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Pe([h,e.pathname])),S=g.createHref(e)}let[C,te,w]=yn(n,p),T=Ln(l,{replace:a,unstable_mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,unstable_defaultShouldRevalidate:f,unstable_useTransitions:v});function ne(t){e&&e(t),t.defaultPrevented||T(t)}let re=!(b.isExternal||i),ie=_.createElement(`a`,{...p,...w,href:(re?S:void 0)||b.absoluteURL||x,onClick:re?ne:e,ref:Tn(m,te),target:c,"data-discover":!y&&t===`render`?`true`:void 0});return C&&!y?_.createElement(_.Fragment,null,ie,_.createElement(xn,{page:x})):ie});An.displayName=`Link`;var jn=_.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=ht(a,{relative:c.relative}),d=ut(),f=_.useContext(qe),{navigator:p,basename:m}=_.useContext($e),h=f!=null&&qn(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,v=d.pathname,y=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(v=v.toLowerCase(),y=y?y.toLowerCase():null,g=g.toLowerCase()),y&&m&&(y=Te(y,m)||y);let b=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,x=v===g||!r&&v.startsWith(g)&&v.charAt(b)===`/`,ee=y!=null&&(y===g||!r&&y.startsWith(g)&&y.charAt(g.length)===`/`),S={isActive:x,isPending:ee,isTransitioning:h},C=x?e:void 0,te;te=typeof n==`function`?n(S):[n,x?`active`:null,ee?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let w=typeof i==`function`?i(S):i;return _.createElement(An,{...c,"aria-current":C,className:te,ref:l,style:w,to:a,viewTransition:o},typeof s==`function`?s(S):s)});jn.displayName=`NavLink`;var Mn=_.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Vt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f,...p},m)=>{let{unstable_useTransitions:h}=_.useContext($e),g=Bn(),v=Vn(s,{relative:l}),y=o.toLowerCase()===`get`?`get`:`post`,b=typeof s==`string`&&kn.test(s);return _.createElement(`form`,{ref:m,method:y,action:v,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f});h&&n!==!1?_.startTransition(()=>p()):p()},...p,"data-discover":!b&&e===`render`?`true`:void 0})});Mn.displayName=`Form`;function Nn({getKey:e,storageKey:t,...n}){let r=_.useContext(_n),{basename:i}=_.useContext($e),a=ut(),o=jt();Gn({getKey:e,storageKey:t});let s=_.useMemo(()=>{if(!r||!e)return null;let t=Wn(a,o,i,e);return t===a.key?null:t},[]);if(!r||r.isSpaMode)return null;let c=((e,t)=>{if(!window.history.state||!window.history.state.key){let e=Math.random().toString(32).slice(2);window.history.replaceState({key:e},``)}try{let n=JSON.parse(sessionStorage.getItem(e)||`{}`)[t||window.history.state.key];typeof n==`number`&&window.scrollTo(0,n)}catch(t){console.error(t),sessionStorage.removeItem(e)}}).toString();return _.createElement(`script`,{...n,suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${c})(${nn(JSON.stringify(t||Hn))}, ${nn(JSON.stringify(s))})`}})}Nn.displayName=`ScrollRestoration`;function Pn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Fn(e){let t=_.useContext(Ke);return w(t,Pn(e)),t}function In(e){let t=_.useContext(qe);return w(t,Pn(e)),t}function Ln(e,{target:t,replace:n,unstable_mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,unstable_defaultShouldRevalidate:c,unstable_useTransitions:l}={}){let u=pt(),d=ut(),f=ht(e,{relative:o});return _.useCallback(p=>{if(Jt(p,t)){p.preventDefault();let t=n===void 0?ae(d)===ae(f):n,m=()=>u(e,{replace:t,unstable_mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,unstable_defaultShouldRevalidate:c});l?_.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}var Rn=0,zn=()=>`__${String(++Rn)}__`;function Bn(){let{router:e}=Fn(`useSubmit`),{basename:t}=_.useContext($e),n=kt(),r=e.fetch,i=e.navigate;return _.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=$t(e,t);a.navigate===!1?await r(a.fetcherKey||zn(),n,a.action||o,{unstable_defaultShouldRevalidate:a.unstable_defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync}):await i(a.action||o,{unstable_defaultShouldRevalidate:a.unstable_defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Vn(e,{relative:t}={}){let{basename:n}=_.useContext($e),r=_.useContext(tt);w(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...ht(e||`.`,{relative:t})},o=ut();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Pe([n,a.pathname])),ae(a)}var Hn=`react-router-scroll-positions`,Un={};function Wn(e,t,n,r){let i=null;return r&&(i=r(n===`/`?e:{...e,pathname:Te(e.pathname,n)||e.pathname},t)),i??=e.key,i}function Gn({getKey:e,storageKey:t}={}){let{router:n}=Fn(`useScrollRestoration`),{restoreScrollPosition:r,preventScrollReset:i}=In(`useScrollRestoration`),{basename:a}=_.useContext($e),o=ut(),s=jt(),c=At();_.useEffect(()=>(window.history.scrollRestoration=`manual`,()=>{window.history.scrollRestoration=`auto`}),[]),Kn(_.useCallback(()=>{if(c.state===`idle`){let t=Wn(o,s,a,e);Un[t]=window.scrollY}try{sessionStorage.setItem(t||Hn,JSON.stringify(Un))}catch(e){T(!1,`Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${e}).`)}window.history.scrollRestoration=`auto`},[c.state,e,a,o,s,t])),typeof document<`u`&&(_.useLayoutEffect(()=>{try{let e=sessionStorage.getItem(t||Hn);e&&(Un=JSON.parse(e))}catch{}},[t]),_.useLayoutEffect(()=>{let t=n?.enableScrollRestoration(Un,()=>window.scrollY,e?(t,n)=>Wn(t,n,a,e):void 0);return()=>t&&t()},[n,a,e]),_.useLayoutEffect(()=>{if(r!==!1){if(typeof r==`number`){window.scrollTo(0,r);return}try{if(o.hash){let e=document.getElementById(decodeURIComponent(o.hash.slice(1)));if(e){e.scrollIntoView();return}}}catch{T(!1,`"${o.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`)}i!==!0&&window.scrollTo(0,0)}},[o,r,i]))}function Kn(e,t){let{capture:n}=t||{};_.useEffect(()=>{let t=n==null?void 0:{capture:n};return window.addEventListener(`pagehide`,e,t),()=>{window.removeEventListener(`pagehide`,e,t)}},[e,n])}function qn(e,{relative:t}={}){let n=_.useContext(Xe);w(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Fn(`useViewTransitionState`),i=ht(e,{relative:t});if(!n.isTransitioning)return!1;let a=Te(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=Te(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Se(i.pathname,o)!=null||Se(i.pathname,a)!=null}var A={colors:{obsidianGray:`#1A1A1B`,sterileWhite:`#F5F5F7`,cobaltBlue:`#0047AB`,brushedSteel:`#A9A9A9`,warningRed:`#D32F2F`,successGreen:`#388E3C`,systemGray:`#616161`,borderGray:`#E0E0E0`},typography:{fontFamily:{primary:`"Inter", "Roboto", "Helvetica Neue", sans-serif`,mono:`"Roboto Mono", "Courier New", monospace`},sizes:{h1:`2.5rem`,h2:`2rem`,h3:`1.5rem`,h4:`1.25rem`,body:`1rem`,small:`0.875rem`,micro:`0.75rem`},weights:{light:300,regular:400,semibold:600,bold:700},lineHeight:{tight:1.2,normal:1.5,relaxed:1.75}},spacing:{xs:`0.5rem`,sm:`1rem`,md:`1.5rem`,lg:`2rem`,xl:`3rem`,xxl:`4rem`},breakpoints:{mobile:`320px`,tablet:`768px`,desktop:`1024px`,wide:`1440px`},shadows:{minimal:`0 1px 3px rgba(0, 0, 0, 0.12)`,subtle:`0 2px 6px rgba(0, 0, 0, 0.1)`,card:`0 4px 12px rgba(0, 0, 0, 0.08)`},borders:{radius:`2px`,weight:`1px`}},Jn=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),j=o(((e,t)=>{t.exports=Jn()}))(),Yn=`
  ...
  .emergency-id {
    color: ${A.colors.warningRed};
    font-weight: ${A.typography.weights.bold};
    text-transform: uppercase;
    letter-spacing: 0.05em;
  }

  .emergency-call {
    background-color: ${A.colors.warningRed};
    color: ${A.colors.sterileWhite};
    ...
    border: none;
    font-size: ${A.typography.sizes.body};
    font-family: ${A.typography.fontFamily.mono};
    font-weight: ${A.typography.weights.bold};
    text-transform: uppercase;
    letter-spacing: 0.05em;
  ...
  .call-number {
    font-size: ${A.typography.sizes.h4};
    font-weight: ${A.typography.weights.bold};
    margin-right: ${A.spacing.md};
  }

  .header-main {
    max-width: 1440px;
    margin: 0 auto;
    padding: ${A.spacing.md} ${A.spacing.lg};
    display: flex;
    justify-content: space-between;
    align-items: center;
  }
  ...
  .logo {
    font-size: ${A.typography.sizes.h2};
    font-weight: ${A.typography.weights.bold};
    color: ${A.colors.cobaltBlue};
    text-transform: uppercase;
    letter-spacing: 0.05em;
  }
  ...
  .nav-link {
    font-size: ${A.typography.sizes.body};
    font-weight: 700;
    color: ${A.colors.obsidianGray};
    cursor: pointer;
    position: relative;
    text-transform: uppercase;
    letter-spacing: 0.08em;
    padding: ${A.spacing.xs} 0;
  ...
  .nav-link::after {
    ...
    width: 0;
    height: 2px;
    background: ${A.colors.cobaltBlue};
  ...
  .nav-link.active {
    color: ${A.colors.cobaltBlue};
    border-bottom-color: ${A.colors.cobaltBlue};
  }
  ...
  .hamburger-line {
    width: 28px;
    height: 2px;
    background-color: ${A.colors.obsidianGray};
  ...
  @media (max-width: ${A.breakpoints.tablet}) {
    ...
    .contact-info {
      gap: ${A.spacing.md};
      font-size: ${A.typography.sizes.micro};
    }
    ...
    .nav-menu {
      ...
      flex-direction: column;
      background-color: ${A.colors.sterileWhite};
      border-bottom: ${A.borders.weight} solid ${A.colors.borderGray};
      gap: 0;
    }
  ...
  @media (max-width: ${A.breakpoints.mobile}) {
    ...
    .logo {
      font-size: ${A.typography.sizes.h3};
    }
...
`,Xn=()=>{let[e,t]=(0,_.useState)(!1),n=ut(),r=[{label:`Services`,path:`/services`},{label:`Projects`,path:`/projects`},{label:`About`,path:`/about`},{label:`Contact`,path:`/contact`}],i=()=>{t(!1),window.scrollTo(0,0)};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:Yn}),(0,j.jsxs)(`header`,{className:`header`,children:[(0,j.jsx)(`div`,{className:`header-top`,children:(0,j.jsxs)(`div`,{className:`header-top-content`,children:[(0,j.jsx)(`div`,{className:`contact-info`,children:(0,j.jsx)(`div`,{className:`contact-item`,children:(0,j.jsx)(`span`,{children:`▬ Licensed & Insured | 24/7 Emergency Response`})})}),(0,j.jsxs)(`div`,{className:`header-top-right`,children:[(0,j.jsx)(`div`,{className:`call-number`,children:`📞 (555) 234-5678`}),(0,j.jsx)(`button`,{className:`emergency-call`,onClick:()=>window.location.href=`tel:5552345678`,children:`CALL NOW`})]})]})}),(0,j.jsxs)(`div`,{className:`header-main`,children:[(0,j.jsx)(An,{to:`/`,style:{textDecoration:`none`,cursor:`pointer`},children:(0,j.jsx)(`div`,{className:`logo`,children:`Enterprise Plumbing`})}),(0,j.jsxs)(`button`,{className:`hamburger ${e?`active`:``}`,onClick:()=>t(!e),"aria-label":`Toggle navigation menu`,children:[(0,j.jsx)(`span`,{className:`hamburger-line`}),(0,j.jsx)(`span`,{className:`hamburger-line`}),(0,j.jsx)(`span`,{className:`hamburger-line`})]}),(0,j.jsx)(`ul`,{className:`nav-menu ${e?`active`:``}`,children:r.map(e=>(0,j.jsx)(`li`,{children:(0,j.jsxs)(An,{to:e.path,style:{textDecoration:`none`,color:`inherit`},onClick:()=>i(),className:`nav-link ${n.pathname===e.path?`active`:``}`,children:[`▸ `,e.label]})},e.path))})]})]})]})},Zn=`
  .footer {
    background-color: ${A.colors.obsidianGray};
    color: ${A.colors.sterileWhite};
    padding: ${A.spacing.xxl} ${A.spacing.lg};
    margin-top: ${A.spacing.xxl};
  }
  ...
  .footer-section li {
    font-size: ${A.typography.sizes.body};
    line-height: ${A.typography.lineHeight.relaxed};
    color: ${A.colors.brushedSteel};
  }
  ...
  .compliance-grid {
    ...
    border: ${A.borders.weight} solid rgba(255, 255, 255, 0.1);
  ...
  .compliance-item {
    border-right: ${A.borders.weight} solid rgba(255, 255, 255, 0.1);
    padding-right: ${A.spacing.lg};
  }
  ...
  .footer-divider {
    border-top: ${A.borders.weight} solid rgba(255, 255, 255, 0.1);
    margin: ${A.spacing.xl} 0;
  }

  .footer-bottom {
    text-align: center;
    padding-top: ${A.spacing.lg};
    border-top: ${A.borders.weight} solid rgba(255, 255, 255, 0.1);
  }
  ...
  @media (max-width: ${A.breakpoints.tablet}) {
    .footer {
      padding: ${A.spacing.xl} ${A.spacing.md};
    }
    ...
    .compliance-item {
      border-right: none;
      border-bottom: ${A.borders.weight} solid rgba(255, 255, 255, 0.1);
      padding-right: 0;
      padding-bottom: ${A.spacing.md};
    }
  ...
  @media (max-width: ${A.breakpoints.mobile}) {
    .footer {
      padding: ${A.spacing.lg} ${A.spacing.sm};
...
`,Qn=()=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:Zn}),(0,j.jsx)(`footer`,{className:`footer`,children:(0,j.jsxs)(`div`,{className:`footer-content`,children:[(0,j.jsxs)(`div`,{className:`footer-grid`,children:[(0,j.jsxs)(`div`,{className:`footer-section`,children:[(0,j.jsx)(`h3`,{children:`Enterprise Plumbing Solutions`}),(0,j.jsx)(`p`,{children:`Tier-1 Industrial & Residential Plumbing Infrastructure Provider`}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Headquarters:`}),` Multi-State Operations Hub`]}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Emergency Dispatch:`}),` Available 24/7/365`]})]}),(0,j.jsxs)(`div`,{className:`footer-section`,children:[(0,j.jsx)(`h3`,{children:`Services`}),(0,j.jsxs)(`ul`,{children:[(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#industrial`,children:`Industrial Solutions`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#residential`,children:`Residential Infrastructure`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#maintenance`,children:`Preventative Maintenance`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#emergency`,children:`Emergency Response`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#diagnostics`,children:`System Diagnostics`})})]})]}),(0,j.jsxs)(`div`,{className:`footer-section`,children:[(0,j.jsx)(`h3`,{children:`Resources`}),(0,j.jsxs)(`ul`,{children:[(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#forum`,children:`Knowledge Base`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#gallery`,children:`Project Gallery`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#testimonials`,children:`Verified Testimonials`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#`,children:`Technical Documentation`})}),(0,j.jsx)(`li`,{children:(0,j.jsx)(`a`,{href:`#`,children:`RFP Template`})})]})]}),(0,j.jsxs)(`div`,{className:`footer-section`,children:[(0,j.jsx)(`h3`,{children:`Contact Information`}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Phone:`}),` +1-XXX-XXX-XXXX`]}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Email:`}),` dispatch@enterprise-plumbing.com`]}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Portal Login:`}),` client.enterprise-plumbing.com`]}),(0,j.jsxs)(`p`,{children:[(0,j.jsx)(`strong`,{children:`Emergency Hotline:`}),` 1-XXX-EMERGENCY`]})]})]}),(0,j.jsxs)(`div`,{className:`compliance-grid`,children:[(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`⚑ State Licensing`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`Licensed in 45+ States`,(0,j.jsx)(`br`,{}),`License Verification Available`]})]}),(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`✉ Bonding Status`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`Fully Bonded & Insured`,(0,j.jsx)(`br`,{}),`$5M Coverage Limit`]})]}),(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`Insurance Liability`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`General Liability: $2M`,(0,j.jsx)(`br`,{}),`Professional: $1M`]})]}),(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`EPA Certifications`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`Water Efficiency Compliant`,(0,j.jsx)(`br`,{}),`Environmental Standards: ISO 14001`]})]}),(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`Industry Standards`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`ISO 9001 Certified`,(0,j.jsx)(`br`,{}),`OSHA Compliance: 100%`]})]}),(0,j.jsxs)(`div`,{className:`compliance-item`,children:[(0,j.jsx)(`div`,{className:`compliance-label`,children:`Code Compliance`}),(0,j.jsxs)(`div`,{className:`compliance-value`,children:[`IPC | IRC | ASME | NFPA 99`,(0,j.jsx)(`br`,{}),`State-Specific Requirements`]})]})]}),(0,j.jsx)(`div`,{className:`footer-divider`}),(0,j.jsxs)(`div`,{className:`footer-bottom`,children:[(0,j.jsxs)(`div`,{className:`footer-links`,children:[(0,j.jsx)(`a`,{href:`#`,children:`Privacy Policy`}),(0,j.jsx)(`a`,{href:`#`,children:`Terms of Service`}),(0,j.jsx)(`a`,{href:`#`,children:`Compliance Documentation`}),(0,j.jsx)(`a`,{href:`#`,children:`Accessibility Statement`}),(0,j.jsx)(`a`,{href:`#`,children:`Sitemap`})]}),(0,j.jsxs)(`p`,{children:[`© `,new Date().getFullYear(),` Enterprise Plumbing Solutions. All rights reserved.`]}),(0,j.jsx)(`p`,{children:`Enterprise Plumbing Solutions is committed to the highest standards of professional service delivery and regulatory compliance.`})]})]})})]}),$n=`
  .hero {
    background: linear-gradient(135deg, ${A.colors.obsidianGray} 0%, ${A.colors.brushedSteel} 100%);
    color: ${A.colors.sterileWhite};
    padding: ${A.spacing.xxl} ${A.spacing.lg};
    text-align: center;
    min-height: 500px;
  ...
  .hero-tagline {
    font-size: ${A.typography.sizes.h3};
    font-weight: ${A.typography.weights.light};
    margin-bottom: ${A.spacing.xl};
    font-family: ${A.typography.fontFamily.mono};
    letter-spacing: 0.05em;
  }
  ...
  .hero-cta {
    background-color: ${A.colors.cobaltBlue};
    color: ${A.colors.sterileWhite};
    padding: ${A.spacing.md} ${A.spacing.xl};
    font-size: ${A.typography.sizes.body};
    font-weight: ${A.typography.weights.semibold};
    border: none;
    cursor: pointer;
    text-transform: uppercase;
    letter-spacing: 0.05em;
  ...
  .hero-secondary-cta {
    ...
    font-size: ${A.typography.sizes.body};
    font-weight: ${A.typography.weights.semibold};
    border: 2px solid ${A.colors.sterileWhite};
    cursor: pointer;
    text-transform: uppercase;
    letter-spacing: 0.05em;
    transition: all 0.3s ease;
...
`,er=()=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:$n}),(0,j.jsx)(`section`,{className:`hero`,children:(0,j.jsxs)(`div`,{className:`hero-content`,children:[(0,j.jsx)(`h1`,{className:`hero-headline`,children:`Professional Plumbing Services`}),(0,j.jsx)(`p`,{className:`hero-tagline`,children:`Residential & Commercial | Emergency & Scheduled Service`}),(0,j.jsx)(`div`,{style:{fontSize:`3rem`,fontWeight:`bold`,color:A.colors.warningRed,marginBottom:A.spacing.xl,fontFamily:A.typography.fontFamily.mono},children:`📞 (555) 234-5678`}),(0,j.jsxs)(`div`,{className:`cta-container`,children:[(0,j.jsx)(`button`,{className:`hero-cta`,onClick:()=>window.location.href=`tel:5552345678`,children:`CALL FOR EMERGENCY`}),(0,j.jsx)(`button`,{className:`hero-secondary-cta`,onClick:()=>window.location.href=`#contact`,children:`REQUEST FREE ESTIMATE`})]})]})})]}),tr=`
  .services-section {
    max-width: 1440px;
    margin: 0 auto;
    padding: ${A.spacing.xxl} ${A.spacing.lg};
  ...
  .service-card {
    background-color: ${A.colors.sterileWhite};
    border: ${A.borders.weight} solid ${A.colors.borderGray};
    overflow: hidden;
    transition: all 0.3s ease;
    box-shadow: ${A.shadows.minimal};
  }

  .service-card:hover {
    border-color: ${A.colors.cobaltBlue};
    box-shadow: ${A.shadows.card};
  ...
  .service-image {
    width: 100%;
    height: 220px;
    background: linear-gradient(135deg, ${A.colors.obsidianGray}, ${A.colors.brushedSteel});
    display: flex;
    align-items: center;
    justify-content: center;
    color: ${A.colors.sterileWhite};
  ...
  .service-description {
    font-size: ${A.typography.sizes.body};
    line-height: ${A.typography.lineHeight.normal};
    color: ${A.colors.systemGray};
  }

  .service-specs {
    margin-top: ${A.spacing.md};
    padding-top: ${A.spacing.md};
    border-top: ${A.borders.weight} solid ${A.colors.borderGray};
    font-size: ${A.typography.sizes.small};
    font-family: ${A.typography.fontFamily.mono};
    color: ${A.colors.brushedSteel};
  }
...
`,nr=[{id:`drain-cleaning`,icon:`▬`,title:`Drain Cleaning & Repair`,description:`Fast drain unclogging, line clearing, and sewer services.`,image:`images/services/drain-repair-featured-image-1.jpg`,specs:[`✓ Same-day service`,`✓ 24/7 emergency available`,`✓ 2-year guarantee`]},{id:`water-lines`,icon:`▬`,title:`Water Line Installation`,description:`New water line installation, replacement, and repair.`,image:`images/services/Water-line-installation.jpg`,specs:[`✓ Copper & PEX certified`,`✓ Licensed plumbers`,`✓ Code compliant`]},{id:`fixtures`,icon:`▬`,title:`Fixture Installation`,description:`Sinks, toilets, faucets, and water heater installation.`,image:`images/services/light-fixture-replacement.avif`,specs:[`✓ All brands supported`,`✓ Professional installation`,`✓ Warranty included`]},{id:`leak-detection`,icon:`▬`,title:`Leak Detection & Repair`,description:`Find and fix hidden leaks before they cause damage.`,image:`images/services/LeakDetectionAndRepair.png`,specs:[`✓ Advanced detection tech`,`✓ Quick turnaround`,`✓ Prevent water damage`]},{id:`maintenance`,icon:`▬`,title:`Preventive Maintenance`,description:`Regular maintenance to prevent expensive repairs.`,image:`images/services/PreventiveMaintenance.jpg`,specs:[`✓ Monthly/quarterly service`,`✓ Inspection included`,`✓ Call anytime`]},{id:`emergency`,icon:`▬`,title:`24/7 Emergency Service`,description:`Burst pipes, major leaks, backups - we're here anytime.`,image:`images/services/24-7-emergency-service-vert.png`,specs:[`✓ Always available`,`✓ Quick response`,`✓ Professional crew`]}],rr=()=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:tr}),(0,j.jsxs)(`section`,{id:`services`,className:`services-section`,children:[(0,j.jsxs)(`div`,{className:`services-header`,children:[(0,j.jsx)(`h2`,{children:`Our Services`}),(0,j.jsx)(`p`,{children:`Licensed • Insured • 24/7 Available`})]}),(0,j.jsx)(`div`,{className:`services-grid`,children:nr.map(e=>(0,j.jsxs)(`div`,{className:`service-card`,children:[(0,j.jsx)(`img`,{src:e.image,alt:e.title,style:{width:`100%`,height:`220px`,objectFit:`cover`,display:`block`}}),(0,j.jsxs)(`div`,{className:`service-content`,children:[(0,j.jsx)(`h3`,{className:`service-title`,children:e.title}),(0,j.jsx)(`p`,{className:`service-description`,children:e.description}),(0,j.jsx)(`div`,{className:`service-specs`,children:e.specs.map((e,t)=>(0,j.jsx)(`div`,{children:e},t))})]})]},e.id))})]})]}),ir=`
  .gallery-section {
    max-width: 1440px;
    margin: 0 auto;
    padding: ${A.spacing.xxl} ${A.spacing.lg};
  ...
  .filter-btn {
    background-color: ${A.colors.sterileWhite};
    color: ${A.colors.obsidianGray};
    border: 2px solid ${A.colors.borderGray};
    padding: ${A.spacing.sm} ${A.spacing.md};
    font-size: ${A.typography.sizes.body};
    font-weight: ${A.typography.weights.semibold};
    cursor: pointer;
...
`,ar=[{id:`proj-001`,title:`Industrial Manifold Assembly`,category:`industrial`,projectId:`EP-2024-IND-001`,systemType:`High-Pressure Manifold`,psiRating:`2500 PSI Max`,complianceStandard:`ASME B16.1`,icon:`⚙`},{id:`proj-002`,title:`Residential Water Main Upgrade`,category:`residential`,projectId:`EP-2024-RES-042`,systemType:`Potable Water Distribution`,psiRating:`80 PSI Operating`,complianceStandard:`IPC 2021`,icon:`💧`},{id:`proj-003`,title:`Commercial HVAC Integration`,category:`industrial`,projectId:`EP-2024-IND-087`,systemType:`Chilled Water Loop`,psiRating:`150 PSI Design`,complianceStandard:`ASHRAE 90.1`,icon:`❄️`},{id:`proj-004`,title:`Emergency Burst Line Repair`,category:`emergency`,projectId:`EP-2024-EMG-159`,systemType:`Copper PEX Replacement`,psiRating:`100 PSI Rated`,complianceStandard:`NSF/ANSI 61`,icon:`⟲`},{id:`proj-005`,title:`Preventative Scale Mitigation`,category:`maintenance`,projectId:`EP-2024-MNT-203`,systemType:`Descaling Treatment Protocol`,psiRating:`N/A (Treatment)`,complianceStandard:`EPA WQA`,icon:`🧪`},{id:`proj-006`,title:`Medical Facility Gas System`,category:`industrial`,projectId:`EP-2024-IND-112`,systemType:`Medical Gas Vacuum`,psiRating:`50 PSI Operating`,complianceStandard:`NFPA 99 / ASSE 6000`,icon:`🏥`}],or=()=>{let[e,t]=(0,_.useState)(null),n=[`industrial`,`residential`,`emergency`,`maintenance`],r=e===null?ar:ar.filter(t=>t.category===e);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:ir}),(0,j.jsxs)(`section`,{id:`gallery`,className:`gallery-section`,children:[(0,j.jsxs)(`div`,{className:`gallery-header`,children:[(0,j.jsx)(`h2`,{children:`⊞ Technical Showcase`}),(0,j.jsx)(`p`,{children:`Project Documentation: Before/After Architectural Overlays & System Specifications`})]}),(0,j.jsxs)(`div`,{className:`filter-buttons`,children:[(0,j.jsx)(`button`,{className:`filter-btn ${e===null?`active`:``}`,onClick:()=>t(null),children:`All Projects`}),n.map(n=>(0,j.jsx)(`button`,{className:`filter-btn ${e===n?`active`:``}`,onClick:()=>t(n),children:n.charAt(0).toUpperCase()+n.slice(1)},n))]}),(0,j.jsx)(`div`,{className:`gallery-grid`,children:r.map(e=>(0,j.jsxs)(`div`,{className:`gallery-item`,children:[(0,j.jsxs)(`div`,{className:`gallery-image-container`,children:[e.icon,(0,j.jsx)(`div`,{className:`gallery-overlay`,children:(0,j.jsx)(`span`,{className:`overlay-text`,children:`View Details`})})]}),(0,j.jsxs)(`div`,{className:`gallery-metadata`,children:[(0,j.jsx)(`div`,{className:`project-id`,children:e.projectId}),(0,j.jsx)(`h3`,{className:`system-type`,children:e.systemType}),(0,j.jsxs)(`div`,{className:`specs-row`,children:[(0,j.jsx)(`span`,{className:`spec-label`,children:`PSI Rating:`}),(0,j.jsx)(`span`,{className:`spec-value`,children:e.psiRating})]}),(0,j.jsxs)(`div`,{className:`specs-row`,children:[(0,j.jsx)(`span`,{className:`spec-label`,children:`Compliance:`}),(0,j.jsx)(`span`,{className:`spec-value`,children:e.complianceStandard})]})]})]},e.id))})]})]})},sr=`
  ...
  .verification-badge {
    display: inline-block;
    background-color: ${A.colors.successGreen};
    color: ${A.colors.sterileWhite};
    padding: 2px ${A.spacing.xs};
    font-size: ${A.typography.sizes.micro};
    border-radius: ${A.borders.radius};
    font-weight: ${A.typography.weights.bold};
    margin-right: ${A.spacing.xs};
    text-transform: uppercase;
    letter-spacing: 0.05em;
  }
...
`,cr=[{id:`test-001`,endorserName:`John Martinez`,title:`Homeowner`,organization:`Chicago, IL`,quote:`Had a major leak in my kitchen. They came same day, fixed it right, and the price was fair. Will definitely call them again.`,rating:5,verificationDate:`2024-04-15`,transactionHash:`0xA7F3...8C2D`},{id:`test-002`,endorserName:`Sarah Johnson`,title:`Property Manager`,organization:`Downtown Apartments`,quote:`Professional, reliable, and they show up on time. They've handled multiple repairs across our building and never let us down.`,rating:5,verificationDate:`2024-03-22`,transactionHash:`0xB4E9...5F1A`},{id:`test-003`,endorserName:`Mike Davis`,title:`Small Business Owner`,organization:`Davis Auto Repair`,quote:`Needed emergency plumbing work done fast. They arrived quickly and got everything fixed with minimal disruption to our business.`,rating:5,verificationDate:`2024-04-01`,transactionHash:`0xC1D7...4E3B`},{id:`test-004`,endorserName:`Lisa Chen`,title:`Homeowner`,organization:`Oak Park, IL`,quote:`Great crew. They explained what needed to be done before they started. No surprises, no upsells. Very honest and professional.`,rating:5,verificationDate:`2024-02-18`,transactionHash:`0xD6A2...9K4L`}],lr=()=>{let e=e=>Array.from({length:e}).map((e,t)=>(0,j.jsx)(`span`,{className:`star`,children:`★`},t));return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:sr}),(0,j.jsxs)(`section`,{id:`testimonials`,className:`testimonials-section`,children:[(0,j.jsxs)(`div`,{className:`testimonials-header`,children:[(0,j.jsx)(`h2`,{children:`What Our Customers Say`}),(0,j.jsx)(`p`,{children:`Real feedback from people just like you`})]}),(0,j.jsx)(`div`,{className:`testimonials-grid`,children:cr.map(t=>(0,j.jsxs)(`div`,{className:`testimonial-card`,children:[(0,j.jsx)(`div`,{className:`rating-display`,children:e(t.rating)}),(0,j.jsxs)(`p`,{className:`quote-text`,children:[`"`,t.quote,`"`]}),(0,j.jsxs)(`div`,{className:`endorser-info`,children:[(0,j.jsx)(`div`,{className:`endorser-name`,children:t.endorserName}),(0,j.jsxs)(`div`,{className:`endorser-title`,children:[(0,j.jsx)(`span`,{className:`verification-badge`,children:`✓ VERIFIED`}),t.title]}),(0,j.jsx)(`div`,{className:`endorser-title`,children:t.organization}),(0,j.jsxs)(`div`,{className:`transaction-hash`,children:[`Transaction Hash: `,t.transactionHash,` |`,` `,t.verificationDate]})]})]},t.id))})]})]})},ur=`
  .forum-section {
    max-width: 1440px;
    margin: 0 auto;
    padding: 4rem 2rem;
...
`,dr=[{id:`thread-001`,title:`PSI Calculation Methods for Complex Manifold Systems`,preview:`Discussion on advanced pressure loss calculations in multi-branch industrial plumbing systems...`,fullContent:`How do you calculate PSI loss in complex manifold systems? Need guidance on pressure calculations for multi-branch industrial configurations.`,authorName:`Thomas Bradley`,authorTier:`master`,category:`Industrial Design`,replies:23,views:847,lastActivity:`2 hours ago`,replyList:[{id:`reply-001`,authorName:`Thomas Bradley`,authorTier:`master`,content:`Using Darcy-Weisbach equation with friction factor adjustments. Standard methodology...`,timestamp:`2 hours ago`}]},{id:`thread-002`,title:`IPC 2021 Compliance for Residential Retrofit Projects`,preview:`Navigating code requirements for existing home water system upgrades...`,fullContent:`What are the key compliance requirements for IPC 2021 in residential retrofit projects?`,authorName:`Alexandra Morgan`,authorTier:`journeyman`,category:`Code Compliance`,replies:15,views:562,lastActivity:`4 hours ago`,replyList:[]},{id:`thread-003`,title:`Copper vs. PEX: Material Selection Criteria`,preview:`Comprehensive comparison for different application contexts...`,fullContent:`What are the pros and cons of copper versus PEX tubing in different scenarios?`,authorName:`Marcus Thompson`,authorTier:`master`,category:`Materials`,replies:34,views:1203,lastActivity:`6 hours ago`,replyList:[]},{id:`thread-004`,title:`Emergency Response: Burst Line Mitigation Protocols`,preview:`Best practices for rapid assessment and temporary/permanent repairs...`,fullContent:`What are the best protocols for responding to burst water lines?`,authorName:`Robert Chen`,authorTier:`journeyman`,category:`Emergency Response`,replies:8,views:421,lastActivity:`12 hours ago`,replyList:[]},{id:`thread-005`,title:`Scaling Prevention: Chemical vs. Physical Methods`,preview:`Debate on descaling techniques for hard water systems...`,fullContent:`Chemical vs physical descaling methods - what works best?`,authorName:`Jennifer Park`,authorTier:`apprentice`,category:`Maintenance`,replies:5,views:187,lastActivity:`1 day ago`,replyList:[]}],fr=[`All`,`Industrial Design`,`Code Compliance`,`Materials`,`Emergency Response`,`Maintenance`],pr=()=>{let[e,t]=(0,_.useState)(`All`),[n,r]=(0,_.useState)(dr),[i,a]=(0,_.useState)(null),[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)(``),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(``),[m,h]=(0,_.useState)(`All`),g=e===`All`?n:n.filter(t=>t.category===e),v=e=>{switch(e){case`master`:return`master-plumber`;case`journeyman`:return`journeyman`;case`apprentice`:return`apprentice`;default:return``}},y=e=>{switch(e){case`master`:return`Master Plumber`;case`journeyman`:return`Journeyman`;case`apprentice`:return`Apprentice`;default:return``}},b=e=>{a(e),s(``),l(``)};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:ur}),(0,j.jsxs)(`section`,{id:`forum`,className:`forum-section`,children:[(0,j.jsxs)(`div`,{className:`forum-header`,children:[(0,j.jsx)(`h2`,{children:`Knowledge Base & Community Forum`}),(0,j.jsx)(`p`,{children:`Ask questions, share solutions, discuss best practices`})]}),(0,j.jsx)(`button`,{className:`create-thread-btn`,onClick:()=>d(!0),children:`✎ START A NEW DISCUSSION`}),u&&(0,j.jsxs)(`div`,{style:{background:`#f5f5f7`,padding:`1.5rem`,marginBottom:`2rem`,border:`1px solid #e0e0e0`},children:[(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Discussion Topic`}),(0,j.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:`What do you want to discuss?`,value:f,onChange:e=>p(e.target.value)})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Category`}),(0,j.jsx)(`select`,{className:`form-input`,value:m,onChange:e=>h(e.target.value),style:{cursor:`pointer`},children:fr.slice(1).map(e=>(0,j.jsx)(`option`,{value:e,children:e},e))})]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:`1rem`},children:[(0,j.jsx)(`button`,{className:`form-submit`,onClick:()=>{!f.trim()||m===`All`||(r([{id:`thread-${Date.now()}`,title:f,preview:`New discussion thread...`,fullContent:`New discussion thread...`,authorName:`You`,authorTier:`apprentice`,category:m,replies:0,views:1,lastActivity:`just now`,replyList:[]},...n]),p(``),h(`All`),d(!1))},children:`Post Discussion`}),(0,j.jsx)(`button`,{className:`form-submit`,onClick:()=>d(!1),style:{backgroundColor:`#a9a9a9`},children:`Cancel`})]})]}),(0,j.jsx)(`div`,{className:`forum-tabs`,children:fr.map(n=>(0,j.jsx)(`button`,{className:`forum-tab ${e===n?`active`:``}`,onClick:()=>t(n),children:n},n))}),(0,j.jsx)(`div`,{className:`forum-threads`,children:g.length===0?(0,j.jsx)(`p`,{style:{textAlign:`center`,color:`#a9a9a9`,padding:`2rem`},children:`No discussions in this category yet. Be the first to start one!`}):g.map(e=>(0,j.jsxs)(`div`,{className:`thread-item`,onClick:()=>b(e),children:[(0,j.jsxs)(`div`,{className:`thread-content`,children:[(0,j.jsx)(`h3`,{className:`thread-title`,children:e.title}),(0,j.jsx)(`p`,{className:`thread-preview`,children:e.preview}),(0,j.jsxs)(`div`,{className:`thread-meta`,children:[(0,j.jsxs)(`span`,{children:[(0,j.jsx)(`span`,{className:`author-badge ${v(e.authorTier)}`,children:y(e.authorTier)}),e.authorName]}),(0,j.jsx)(`span`,{children:e.lastActivity})]})]}),(0,j.jsxs)(`div`,{className:`thread-stats`,children:[(0,j.jsx)(`div`,{className:`reply-count`,children:e.replies}),(0,j.jsxs)(`div`,{className:`view-count`,children:[e.views,` views`]})]})]},e.id))})]}),i&&(0,j.jsx)(`div`,{className:`modal-overlay`,onClick:()=>a(null),children:(0,j.jsxs)(`div`,{className:`modal-content`,onClick:e=>e.stopPropagation(),children:[(0,j.jsxs)(`div`,{className:`modal-header`,children:[(0,j.jsx)(`h2`,{className:`modal-title`,children:i.title}),(0,j.jsx)(`button`,{className:`modal-close`,onClick:()=>a(null),children:`✕`})]}),(0,j.jsxs)(`div`,{className:`modal-body`,children:[(0,j.jsxs)(`div`,{style:{marginBottom:`1.5rem`,paddingBottom:`1.5rem`,borderBottom:`1px solid #e0e0e0`},children:[(0,j.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.5rem`,marginBottom:`1rem`,fontSize:`0.9rem`},children:[(0,j.jsx)(`span`,{className:`author-badge ${v(i.authorTier)}`,children:y(i.authorTier)}),(0,j.jsx)(`strong`,{children:i.authorName}),(0,j.jsxs)(`span`,{style:{color:`#a9a9a9`},children:[`• `,i.lastActivity]})]}),(0,j.jsx)(`p`,{style:{color:`#1a1a1b`,lineHeight:`1.6`},children:i.fullContent||i.preview})]}),i.replyList&&i.replyList.length>0&&(0,j.jsxs)(`div`,{className:`replies-section`,children:[(0,j.jsxs)(`h3`,{style:{marginBottom:`1rem`,color:`#1a1a1b`},children:[i.replyList.length,` Replies`]}),i.replyList.map(e=>(0,j.jsxs)(`div`,{className:`reply-item`,children:[(0,j.jsxs)(`div`,{className:`reply-author`,children:[(0,j.jsx)(`span`,{className:`author-badge ${v(e.authorTier)}`,children:y(e.authorTier)}),e.authorName,(0,j.jsxs)(`span`,{className:`reply-time`,children:[`• `,e.timestamp]})]}),(0,j.jsx)(`div`,{className:`reply-text`,children:e.content})]},e.id))]}),(0,j.jsxs)(`div`,{className:`reply-form`,children:[(0,j.jsx)(`h3`,{style:{marginBottom:`1rem`,color:`#1a1a1b`},children:`Add Your Reply`}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Your Name`}),(0,j.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:`Enter your name`,value:c,onChange:e=>l(e.target.value)})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Your Reply`}),(0,j.jsx)(`textarea`,{className:`form-textarea`,placeholder:`Share your thoughts...`,value:o,onChange:e=>s(e.target.value)})]}),(0,j.jsx)(`button`,{className:`form-submit`,onClick:()=>{if(!o.trim()||!c.trim()||!i)return;let e={...i,replies:i.replies+1,replyList:[...i.replyList||[],{id:`reply-${Date.now()}`,authorName:c,authorTier:`apprentice`,content:o,timestamp:`just now`}]};r(n.map(t=>t.id===i.id?e:t)),a(e),s(``),l(``)},children:`Post Reply`})]})]})]})})]})};function mr(){return(0,j.jsxs)(`div`,{style:{animation:`fadeIn 0.6s ease-in-out`},children:[(0,j.jsx)(er,{}),(0,j.jsx)(rr,{}),(0,j.jsx)(or,{}),(0,j.jsx)(lr,{}),(0,j.jsx)(pr,{})]})}var hr={obsidianGray:`#1A1A1B`,sterileWhite:`#F5F5F7`,cobaltBlue:`#0047AB`,brushedSteel:`#A9A9A9`,warningRed:`#D32F2F`,successGreen:`#388E3C`},gr={xs:`0.5rem`,sm:`1rem`,md:`1.5rem`,lg:`2rem`,xl:`3rem`,xxl:`4rem`};hr.cobaltBlue,hr.warningRed,hr.obsidianGray,hr.cobaltBlue;var _r=[{title:`Industrial Solutions`,category:`INDUSTRIAL`,description:`Mission-critical hydraulic infrastructure for manufacturing, processing, and heavy industrial applications. Engineered for extreme pressure environments exceeding 2500+ PSI.`,specifications:[`Pressure Range: 2500-5000 PSI`,`Material: ASME Grade A Stainless`,`Compliance: ASME B31.1, B31.3, B31.9`,`Testing: Hydrostatic @ 1.5x rated pressure`,`Certification: ISO 9001, ISO 14001`],benefits:[`Zero-downtime installation protocols`,`Predictive maintenance analytics`,`24/7 emergency response team`,`Full system diagnostics included`],icon:`◆`,projectCount:247},{title:`Residential Infrastructure`,category:`RESIDENTIAL`,description:`Complete piping systems for multi-unit residential facilities. IPC 2021 and IRC compliant installations for apartments, condominiums, and residential complexes.`,specifications:[`Pressure Range: 40-80 PSI`,`Material: PEX-A, Copper, or Stainless`,`Compliance: IPC 2021, IRC 2021`,`Testing: Water pressure test @ 80 PSI`,`Certification: EPA Lead-Free`],benefits:[`Lifetime corrosion warranties`,`Silent operation design`,`Water efficiency optimization`,`Seismic resilience engineering`],icon:`▪`,projectCount:512},{title:`Preventative Maintenance`,category:`MAINTENANCE`,description:`Strategic maintenance programs extending system lifespan by 15-30%. Scheduled assessments prevent catastrophic failures and optimize operational efficiency.`,specifications:[`Inspection Interval: 6-12 months`,`Assessment Method: Video scope, flow rate`,`Reporting: Detailed technical analysis`,`Certification: Maintenance Log ISO 19011`,`Response Time: 48 hours`],benefits:[`Extend system life 15-30%`,`Reduce emergency repairs 85%`,`Lower operational costs 20-40%`,`Compliance verification included`],icon:`◉`,projectCount:890}],M={colors:hr,spacing:gr};function vr(){return(0,j.jsxs)(`div`,{style:{animation:`fadeIn 0.6s ease-in-out`},children:[(0,j.jsx)(`style`,{children:`
        .services-detail-header {
          background: linear-gradient(135deg, ${M.colors.obsidianGray} 0%, ${M.colors.brushedSteel} 100%);
          color: ${M.colors.sterileWhite};
          padding: 6rem 2rem;
          text-align: center;
          animation: slideDown 0.8s ease-out;
          border-bottom: 3px solid ${M.colors.cobaltBlue};
        }
        ...
        .service-card-detail {
          background: ${M.colors.sterileWhite};
          border: 2px solid ${M.colors.cobaltBlue};
          padding: 2.5rem;
          border-radius: 0;
        ...
        .service-card-detail::before {
          ...
          width: 100%;
          height: 4px;
          background: linear-gradient(90deg, ${M.colors.cobaltBlue}, ${M.colors.brushedSteel});
        ...
        .service-card-detail:hover {
          border-color: ${M.colors.obsidianGray};
        ...
        .service-category {
          ...
          border-bottom: 1px solid ${M.colors.cobaltBlue};
          display: inline-block;
        }

        .service-card-detail p {
          color: ${M.colors.brushedSteel};
          line-height: 1.7;
        ...
        .project-count {
          ...
          border: 1px solid ${M.colors.cobaltBlue};
          letter-spacing: 0.08em;
          transition: all 0.3s ease;
        }
      ...
      `}),(0,j.jsxs)(`div`,{className:`services-detail-header`,children:[(0,j.jsx)(`h1`,{children:`SERVICE MATRIX`}),(0,j.jsx)(`p`,{style:{fontSize:`1.1rem`,opacity:.9},children:`Comprehensive engineering solutions for plumbing infrastructure`})]}),(0,j.jsx)(`div`,{className:`services-detail-grid`,children:_r.map((e,t)=>(0,j.jsxs)(`div`,{className:`service-card-detail`,children:[(0,j.jsx)(`div`,{className:`service-icon`,children:e.icon}),(0,j.jsx)(`div`,{className:`service-category`,children:e.category}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsx)(`p`,{children:e.description}),(0,j.jsxs)(`div`,{className:`specs-section`,children:[(0,j.jsx)(`div`,{className:`section-title`,children:`Specifications`}),(0,j.jsx)(`ul`,{className:`specs-list`,children:e.specifications.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))})]}),(0,j.jsxs)(`div`,{className:`benefits-section`,children:[(0,j.jsx)(`div`,{className:`section-title`,children:`Key Benefits`}),(0,j.jsx)(`ul`,{className:`benefits-list`,children:e.benefits.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))})]}),(0,j.jsxs)(`div`,{className:`project-count`,children:[e.projectCount,`+ PROJECTS`]})]},t))})]})}var yr=[{id:`2024-001`,name:`PEX Water Line Replacement`,location:`Lincoln Square, Chicago`,scope:`Complete copper to PEX conversion for 4-unit residential building. Replaced aging copper lines with modern PEX tubing, improving water quality and reducing corrosion issues.`,duration:`2 days`,investment:`$3,200`,metrics:[`✓ No more water discoloration`,`✓ Improved water pressure`,`✓ 50-year pipe warranty`,`✓ Installed leak detection`],image:`images/work/Copper PEX Replacement.png`,status:`COMPLETED`},{id:`2024-002`,name:`High-Flow Manifold Installation`,location:`Bucktown, Chicago`,scope:`Installed advanced high-pressure manifold system for multi-unit building. This professional-grade equipment handles multiple supply lines with precision control.`,duration:`1 day`,investment:`$2,100`,metrics:[`✓ Professional manifold system`,`✓ Precise pressure control`,`✓ Multiple supply support`,`✓ Future-proof design`],image:`images/work/High-Pressure Manifold.png`,status:`COMPLETED`},{id:`2024-003`,name:`Residential Drain System Overhaul`,location:`Wicker Park, Chicago`,scope:`Complete drain cleaning and repair project. Used descaling treatment protocol to remove years of buildup, restored full water flow, and repaired damaged sections.`,duration:`4 hours`,investment:`$1,850`,metrics:[`✓ Chemical-free descaling`,`✓ Full water restoration`,`✓ No blockages remaining`,`✓ 2-year guarantee`],image:`images/work/Descaling Treatment Protocol.png`,status:`COMPLETED`},{id:`2024-004`,name:`Commercial Building Water Distribution`,location:`Loop District, Chicago`,scope:`Designed and installed complete potable water distribution system for 8-story commercial building. Includes pressure regulation, filtration, and emergency shut-off valves.`,duration:`3 weeks`,investment:`$12,500`,metrics:[`✓ Code-compliant installation`,`✓ Full redundancy system`,`✓ Smart metering included`,`✓ Certified by city inspector`],image:`images/work/Potable Water Distribution.png`,status:`COMPLETED`},{id:`2024-005`,name:`Emergency Water Main Repair`,location:`Lakeview, Chicago`,scope:`Emergency response to burst water main affecting 20+ residential units. Rapid diagnosis, temporary repair, and full replacement completed within 6 hours.`,duration:`6 hours`,investment:`$4,500`,metrics:[`✓ Same-day response`,`✓ Minimal disruption`,`✓ Zero water damage`,`✓ Full system restored`],image:`images/work/plumbing123-1024x707.jpg`,status:`COMPLETED`},{id:`2024-006`,name:`Preventive Maintenance Program`,location:`Multiple Locations`,scope:`Ongoing preventive maintenance for 15 residential properties. Quarterly inspections, valve maintenance, and early leak detection saved customers thousands in emergency repairs.`,duration:`Ongoing`,investment:`$95/month per unit`,metrics:[`✓ Quarterly inspections`,`✓ Early leak detection`,`✓ 24/7 priority service`,`✓ Preventive repairs included`],image:`images/work/Chilled Water Loop.png`,status:`IN-PROGRESS`},{id:`2024-007`,name:`Advanced Water System Installation`,location:`Hyde Park, Chicago`,scope:`Installed professional-grade water treatment and distribution system with advanced filtration for luxury residential building. Included smart monitoring and automated valve systems.`,duration:`2 weeks`,investment:`$8,500`,metrics:[`✓ Professional equipment`,`✓ Smart water monitoring`,`✓ Advanced filtration system`,`✓ 24/7 emergency support`],image:`images/work/Medical Gas Vacuum.png`,status:`COMPLETED`}],N={colors:hr,spacing:gr};function br(){return(0,j.jsxs)(`div`,{style:{animation:`fadeIn 0.6s ease-in-out`},children:[(0,j.jsx)(`style`,{children:`
        .projects-header {
          background: linear-gradient(135deg, ${N.colors.obsidianGray} 0%, ${N.colors.brushedSteel} 100%);
          color: ${N.colors.sterileWhite};
          padding: 6rem 2rem;
          text-align: center;
          animation: slideDown 0.8s ease-out;
        }
        ...
        .project-card {
          background: ${N.colors.sterileWhite};
        ...
        .project-card:hover {
          border-color: ${N.colors.cobaltBlue};
          box-shadow: 0 25px 50px rgba(0, 71, 171, 0.2);
          transform: translateY(-10px);
        }
        ...
        .project-status.completed {
          ...
          color: ${N.colors.successGreen};
          border: 1px solid ${N.colors.successGreen};
        }

        .project-status.in-progress {
          background: rgba(211, 47, 47, 0.1);
          color: ${N.colors.warningRed};
          border: 1px solid ${N.colors.warningRed};
        }
      ...
      `}),(0,j.jsxs)(`div`,{className:`projects-header`,children:[(0,j.jsx)(`h1`,{children:`COMPLETED PROJECTS`}),(0,j.jsx)(`p`,{style:{fontSize:`1.1rem`,opacity:.9},children:`Real work from real Chicago plumbers`}),(0,j.jsxs)(`div`,{className:`projects-stats`,children:[(0,j.jsxs)(`div`,{className:`stat-box`,children:[(0,j.jsx)(`div`,{className:`stat-number`,children:`250+`}),(0,j.jsx)(`div`,{className:`stat-label`,children:`Projects This Year`})]}),(0,j.jsxs)(`div`,{className:`stat-box`,children:[(0,j.jsx)(`div`,{className:`stat-number`,children:`$1.2M`}),(0,j.jsx)(`div`,{className:`stat-label`,children:`Total Work Value`})]}),(0,j.jsxs)(`div`,{className:`stat-box`,children:[(0,j.jsx)(`div`,{className:`stat-number`,children:`4.9★`}),(0,j.jsx)(`div`,{className:`stat-label`,children:`Average Rating`})]})]})]}),(0,j.jsx)(`div`,{className:`projects-grid`,children:yr.map(e=>(0,j.jsxs)(`div`,{className:`project-card`,children:[(0,j.jsx)(`div`,{style:{width:`100%`,height:`220px`,overflow:`hidden`,background:`#f0f0f0`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,j.jsx)(`img`,{src:e.image,alt:e.name,style:{width:`100%`,height:`100%`,objectFit:`cover`,display:`block`}})}),(0,j.jsxs)(`div`,{className:`project-header`,children:[(0,j.jsx)(`div`,{className:`project-status ${e.status.toLowerCase().replace(`-`,``)}`,children:e.status}),(0,j.jsx)(`div`,{className:`project-id`,children:e.id}),(0,j.jsx)(`h2`,{children:e.name}),(0,j.jsxs)(`div`,{className:`project-location`,children:[`📍 `,e.location]})]}),(0,j.jsxs)(`div`,{className:`project-body`,children:[(0,j.jsx)(`p`,{children:e.scope}),(0,j.jsxs)(`div`,{className:`project-details`,children:[(0,j.jsxs)(`div`,{className:`detail-item`,children:[(0,j.jsx)(`div`,{className:`detail-label`,children:`Duration`}),(0,j.jsx)(`div`,{className:`detail-value`,children:e.duration})]}),(0,j.jsxs)(`div`,{className:`detail-item`,children:[(0,j.jsx)(`div`,{className:`detail-label`,children:`Investment`}),(0,j.jsx)(`div`,{className:`detail-value`,children:e.investment})]})]}),(0,j.jsx)(`ul`,{className:`metrics-list`,children:e.metrics.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))})]})]},e.id))})]})}var P={colors:hr,spacing:gr};function xr(){return(0,j.jsxs)(`div`,{style:{animation:`fadeIn 0.6s ease-in-out`},children:[(0,j.jsx)(`style`,{children:`
        .about-hero {
          background: linear-gradient(135deg, ${P.colors.obsidianGray} 0%, ${P.colors.brushedSteel} 100%);
          color: ${P.colors.sterileWhite};
          padding: 6rem 2rem;
          text-align: center;
          animation: slideDown 0.8s ease-out;
        }
        ...
        .about-section h2 {
          font-size: 1.8rem;
          color: ${P.colors.obsidianGray};
          margin-bottom: ${P.spacing.lg};
          text-transform: uppercase;
          letter-spacing: 0.05em;
          position: relative;
          padding-bottom: 1rem;
          border-bottom: 2px solid ${P.colors.cobaltBlue};
        }

        .about-section p {
          color: ${P.colors.brushedSteel};
          line-height: 1.8;
          font-size: 1rem;
          margin-bottom: ${P.spacing.lg};
        }
        ...
        .value-card:hover {
          ...
          border-color: ${P.colors.cobaltBlue};
        }

        .value-card h3 {
          color: ${P.colors.cobaltBlue};
          font-size: 1.1rem;
          text-transform: uppercase;
          letter-spacing: 0.05em;
          margin-bottom: ${P.spacing.md};
        ...
        .timeline-item:before {
          ...
          width: 20px;
          height: 20px;
          background: ${P.colors.cobaltBlue};
          border: 3px solid ${P.colors.sterileWhite};
          border-radius: 50%;
          box-shadow: 0 0 0 3px ${P.colors.cobaltBlue};
        }
        ...
        .cert-badge {
          ...
          border: 1px solid ${P.colors.successGreen};
          padding: 1.5rem;
          text-align: center;
          transition: all 0.3s ease;
        }
      ...
      `}),(0,j.jsxs)(`div`,{className:`about-hero`,children:[(0,j.jsx)(`h1`,{children:`ABOUT CHICAGO HIGHLIGHT PLUMBING`}),(0,j.jsx)(`p`,{style:{fontSize:`1.1rem`,opacity:.9},children:`Licensed, insured, and trusted by Chicago families since 2015`})]}),(0,j.jsxs)(`div`,{className:`about-content`,children:[(0,j.jsx)(`div`,{style:{textAlign:`center`,marginBottom:`3rem`,padding:`2rem`},children:(0,j.jsx)(`img`,{src:`images/badges/Logo.png`,alt:`Chicago Highlight Plumbing Badge`,style:{maxWidth:`200px`,height:`auto`,animation:`fadeIn 0.8s ease-in-out`}})}),(0,j.jsxs)(`div`,{className:`about-section`,children:[(0,j.jsx)(`h2`,{children:`Who We Are`}),(0,j.jsx)(`p`,{children:`We're a professional plumbing company serving Chicago and the surrounding areas. We fix leaks, unplug drains, install new fixtures, and handle emergency water main breaks. No corporate jargon—just licensed plumbers who show up on time, fix the problem, and charge a fair price.`})]}),(0,j.jsxs)(`div`,{className:`about-section`,children:[(0,j.jsx)(`h2`,{children:`What We Do`}),(0,j.jsxs)(`div`,{className:`values-grid`,children:[(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Drain Cleaning`}),(0,j.jsx)(`p`,{children:`Clogs, backups, slow drains—we clear them fast. No chemicals needed, just professional equipment and years of experience.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Water Line Work`}),(0,j.jsx)(`p`,{children:`Old copper pipes? Cracked mains? We replace water lines with modern, durable materials. New customers love the improved water quality.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Fixture Installation`}),(0,j.jsx)(`p`,{children:`New faucets, sinks, toilets, showers—we install everything correctly. All work comes with a 1-year guarantee.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Leak Detection`}),(0,j.jsx)(`p`,{children:`Find hidden leaks before they cost thousands in water damage. We use professional equipment to pinpoint the exact location.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Emergency Service`}),(0,j.jsx)(`p`,{children:`24/7 availability. Water main breaks, burst pipes, backed-up sewers—we respond the same day, often within hours.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Preventive Maintenance`}),(0,j.jsx)(`p`,{children:`Quarterly inspections, valve checks, and early leak detection save customers thousands in emergency repairs.`})]})]})]}),(0,j.jsxs)(`div`,{className:`about-section`,children:[(0,j.jsx)(`h2`,{children:`Our Team`}),(0,j.jsx)(`p`,{children:`Every plumber on our team is licensed, insured, and trained to handle the full range of residential and commercial plumbing work. We don't hire inexperienced crew—every person who shows up at your door knows how to do the job right, the first time.`}),(0,j.jsx)(`p`,{children:`We're also not some massive corporation where you get transferred between departments. When you call us, you talk to the people who will actually do your work.`})]}),(0,j.jsxs)(`div`,{className:`about-section`,children:[(0,j.jsx)(`h2`,{children:`Why Choose Us`}),(0,j.jsxs)(`div`,{className:`values-grid`,children:[(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Licensed & Insured`}),(0,j.jsx)(`p`,{children:`Full licensing and comprehensive insurance coverage. You're protected on every job.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Honest Pricing`}),(0,j.jsx)(`p`,{children:`No hidden fees. We quote the job, we stick to the quote. If something unexpected comes up, we ask first.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Same-Day Service`}),(0,j.jsx)(`p`,{children:`Call us today, we come today. Emergency service available 24/7/365.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Work Guaranteed`}),(0,j.jsx)(`p`,{children:`Everything we install comes with a warranty. If something fails, we fix it free.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Professional Service`}),(0,j.jsx)(`p`,{children:`Clean, respectful service. We protect your home, explain the work, and leave your space clean.`})]}),(0,j.jsxs)(`div`,{className:`value-card`,children:[(0,j.jsx)(`h3`,{children:`Real Results`}),(0,j.jsx)(`p`,{children:`400+ 5-star reviews from Chicago homeowners. Our customers are our best advertisement.`})]})]})]}),(0,j.jsxs)(`div`,{className:`about-section`,children:[(0,j.jsx)(`h2`,{children:`Ready to work with us?`}),(0,j.jsxs)(`p`,{style:{fontSize:`1.1rem`,lineHeight:`1.8`},children:[(0,j.jsx)(`strong`,{style:{color:P.colors.warningRed,fontSize:`1.3rem`},children:`(555) 234-5678`}),(0,j.jsx)(`br`,{}),`Call anytime—we're here to help. No job too small, no emergency too big.`]})]})]})]})}var F={colors:hr,spacing:gr};function Sr(){let[e,t]=(0,_.useState)({name:``,phone:``,address:``,issue:``}),[n,r]=(0,_.useState)(!1),i=n=>{t({...e,[n.target.name]:n.target.value})};return(0,j.jsxs)(`div`,{style:{animation:`fadeIn 0.6s ease-in-out`},children:[(0,j.jsx)(`style`,{children:`
        .contact-hero {
          background: linear-gradient(135deg, ${F.colors.obsidianGray} 0%, ${F.colors.brushedSteel} 100%);
          color: ${F.colors.sterileWhite};
          padding: 4rem 2rem;
          text-align: center;
          animation: slideDown 0.8s ease-out;
        }
        ...
        .big-phone {
          font-size: 4rem;
          font-weight: 900;
          color: ${F.colors.warningRed};
          margin: 2rem 0;
          font-family: 'Courier New', monospace;
        }

        .cta-button {
          background: ${F.colors.warningRed};
          color: white;
          padding: 1rem 2rem;
          font-size: 1.2rem;
          border: none;
        ...
        .form-textarea {
          width: 100%;
          padding: 0.75rem;
          background: ${F.colors.sterileWhite};
        ...
        .form-textarea:focus {
          outline: none;
          border-color: ${F.colors.cobaltBlue};
          box-shadow: 0 0 0 3px rgba(0, 71, 171, 0.1);
        }
        ...
        .submit-btn {
          width: 100%;
          padding: 1rem;
          background: ${F.colors.cobaltBlue};
          color: ${F.colors.sterileWhite};
          border: none;
          font-size: 0.9rem;
          font-weight: 700;
        ...
        .success-message {
          background: rgba(56, 142, 60, 0.1);
          border: 1px solid ${F.colors.successGreen};
          color: ${F.colors.successGreen};
          padding: 1rem;
          text-align: center;
          font-weight: 600;
      ...
      `}),(0,j.jsxs)(`div`,{className:`contact-hero`,children:[(0,j.jsx)(`h1`,{children:`Need a Plumber?`}),(0,j.jsx)(`div`,{className:`big-phone`,children:`(555) 234-5678`}),(0,j.jsx)(`button`,{className:`cta-button`,onClick:()=>window.location.href=`tel:5552345678`,children:`Call Now`}),(0,j.jsx)(`p`,{style:{marginTop:`1rem`,fontSize:`1.1rem`},children:`Available 24/7 for emergencies`})]}),(0,j.jsxs)(`div`,{className:`contact-container`,children:[(0,j.jsxs)(`div`,{className:`contact-info`,children:[(0,j.jsx)(`h2`,{children:`How It Works`}),(0,j.jsxs)(`p`,{children:[`1. Call us now or fill out the form`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`2. We'll send a plumber to your location`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`3. We'll give you a price before we start`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`4. We fix the problem and you pay`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`5. Done! No hidden fees ever.`]}),(0,j.jsxs)(`div`,{className:`contact-item`,style:{marginTop:`2rem`},children:[(0,j.jsx)(`div`,{className:`contact-label`,children:`Service Areas`}),(0,j.jsx)(`div`,{className:`contact-value`,children:`Chicago & Suburbs`})]}),(0,j.jsxs)(`div`,{className:`contact-item`,children:[(0,j.jsx)(`div`,{className:`contact-label`,children:`Emergency Response`}),(0,j.jsx)(`div`,{className:`contact-value`,children:`Usually within 45 minutes`})]}),(0,j.jsxs)(`div`,{className:`contact-item`,children:[(0,j.jsx)(`div`,{className:`contact-label`,children:`We Accept`}),(0,j.jsx)(`div`,{className:`contact-value`,children:`Cash, Check, Cards, Financing`})]})]}),(0,j.jsx)(`div`,{className:`contact-form-wrapper`,children:(0,j.jsxs)(`div`,{className:`contact-form`,children:[(0,j.jsx)(`h3`,{children:`Schedule Service`}),n&&(0,j.jsx)(`div`,{className:`success-message`,children:`✓ We got your info. A plumber will call you soon!`}),!n&&(0,j.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),r(!0),setTimeout(()=>{t({name:``,phone:``,address:``,issue:``}),r(!1)},4e3)},children:[(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Your Name`}),(0,j.jsx)(`input`,{type:`text`,name:`name`,className:`form-input`,value:e.name,onChange:i,placeholder:`John Smith`,required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Phone`}),(0,j.jsx)(`input`,{type:`tel`,name:`phone`,className:`form-input`,value:e.phone,onChange:i,placeholder:`(555) 123-4567`,required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`Address`}),(0,j.jsx)(`input`,{type:`text`,name:`address`,className:`form-input`,value:e.address,onChange:i,placeholder:`123 Main St, Chicago, IL`,required:!0})]}),(0,j.jsxs)(`div`,{className:`form-group`,children:[(0,j.jsx)(`label`,{className:`form-label`,children:`What's the problem?`}),(0,j.jsx)(`textarea`,{name:`issue`,className:`form-textarea`,value:e.issue,onChange:i,placeholder:`Leaky pipe? Clogged drain? Water heater broken?`,required:!0})]}),(0,j.jsx)(`button`,{type:`submit`,className:`submit-btn`,children:`Schedule Service`})]})]})})]})]})}var Cr=`
  * {
    margin: 0;
    padding: 0;
    box-sizing: border-box;
  ...
  body {
    ...
    font-size: ${A.typography.sizes.body};
    font-weight: ${A.typography.weights.regular};
    line-height: ${A.typography.lineHeight.normal};
    color: ${A.colors.obsidianGray};
    background-color: ${A.colors.sterileWhite};
  }
  ...
  h1 {
    font-size: ${A.typography.sizes.h1};
  }
  ...
  code {
    font-family: ${A.typography.fontFamily.mono};
    background-color: ${A.colors.brushedSteel};
    color: ${A.colors.sterileWhite};
...
`,wr=e=>({"@context":`https://schema.org`,"@type":`LocalBusiness`,"@id":`#organization`,name:e.name,description:e.description,image:`images/badges/Logo.png`,telephone:e.telephone,email:e.email,url:`https://plumbing-enterprise.com`,address:{"@type":`PostalAddress`,streetAddress:e.address.streetAddress,addressLocality:e.address.addressLocality,addressRegion:e.address.addressRegion,postalCode:e.address.postalCode,addressCountry:e.address.addressCountry},foundingDate:e.foundingDate,sameAs:e.sameAs,areaServed:e.areaServed,priceRange:e.priceRange}),Tr=()=>({"@context":`https://schema.org`,"@type":`ProfessionalService`,name:`Enterprise Plumbing Solutions`,description:`Tier-1 industrial and residential plumbing infrastructure provider`,areaServed:{"@type":`State`,name:`United States`},serviceType:[`Industrial Plumbing`,`Residential Infrastructure`,`Preventative Maintenance`,`Emergency Response`,`High-Pressure Systems`],hasCredential:{"@type":`EducationalOccupationalCredential`,credentialCategory:`State Plumber License`},telephone:`+1-XXX-XXX-XXXX`,email:`dispatch@enterprise-plumbing.com`,operatingHours:{"@type":`OpeningHoursSpecification`,dayOfWeek:[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`],opens:`00:00`,closes:`23:59`}}),Er=(e,t)=>({"@context":`https://schema.org`,"@type":`AggregateRating`,"@id":`#aggregate-review`,ratingValue:e,reviewCount:t,bestRating:5,worstRating:1});function Dr(){let e=ut();return(0,_.useEffect)(()=>{let e=document.createElement(`script`);e.type=`application/ld+json`,e.textContent=JSON.stringify(wr({name:`Chicago Highlight Plumbing`,description:`Licensed, insured, trusted Chicago plumbing company. Emergency & scheduled service, residential & commercial.`,telephone:`+1-555-234-5678`,address:{streetAddress:`Chicago, IL`,addressLocality:`Chicago`,addressRegion:`IL`,postalCode:`60601`,addressCountry:`US`},email:`contact@chicagohighlight.com`,foundingDate:`2015-01-01`,sameAs:[],areaServed:[`Chicago`,`Illinois`],priceRange:`$$`})),document.head.appendChild(e);let t=document.createElement(`script`);t.type=`application/ld+json`,t.textContent=JSON.stringify(Tr()),document.head.appendChild(t);let n=document.createElement(`script`);n.type=`application/ld+json`,n.textContent=JSON.stringify(Er(4.9,187)),document.head.appendChild(n);let r=document.createElement(`style`);return r.textContent=Cr,document.head.appendChild(r),()=>{document.head.removeChild(e),document.head.removeChild(t),document.head.removeChild(n),document.head.removeChild(r)}},[]),(0,_.useEffect)(()=>{window.scrollTo(0,0)},[e]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(Xn,{}),(0,j.jsx)(`main`,{style:{minHeight:`calc(100vh - 120px)`},children:(0,j.jsxs)(zt,{children:[(0,j.jsx)(Lt,{path:`/`,element:(0,j.jsx)(mr,{})}),(0,j.jsx)(Lt,{path:`/services`,element:(0,j.jsx)(vr,{})}),(0,j.jsx)(Lt,{path:`/projects`,element:(0,j.jsx)(br,{})}),(0,j.jsx)(Lt,{path:`/about`,element:(0,j.jsx)(xr,{})}),(0,j.jsx)(Lt,{path:`/contact`,element:(0,j.jsx)(Sr,{})})]})}),(0,j.jsx)(Qn,{})]})}function Or(){return(0,j.jsx)(Dn,{basename:`/Plumbing/`,children:(0,j.jsx)(Dr,{})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(_.StrictMode,{children:(0,j.jsx)(Or,{})}));